...
namespace QLTVT
{
    ...
    */
    static class Program
    {
        ...
        public static String connstrPublisher = "Data Source=MINHHOANG;Initial Catalog=QLVT_DATHANG;Integrated Security=true";
         ...
         ***********************************************/
        public static String serverName = "MINHHOANG/SERVER01";//servername
        public static String serverNameLeft = "MINHHOANG/SERVER02";
        public static String userName = "LT";//username

        public static String loginName = "LT";//mlogin
        public static String loginPassword = "123";//password
        ...
        public static String currentLogin = "LT";//mloginDN
        public static String currentPassword = "123";//passwordDN
